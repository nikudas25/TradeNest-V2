...
export function ProductPage() {
    ...
    useEffect(() => {
        ...
        loadProduct(); // ✅ THIS LINE FIXES EVERYTHING
    }, [slug]);
            ...
            <section className="product-detail-layout">
                ...
                <div className="product-detail-copy">
                    ...
                    <div className="chip-row">
                        ...
                        <span
                            className="detail-chip">{String(product.authenticity_status || "").replaceAll("_", " ")}</span>
                        <span
                            className="detail-chip">{product.escrow_required ? "Escrow protected" : "Direct sale"}</span>
                    </div>
